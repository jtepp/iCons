...
//        String req = getIntent().getStringExtra("itemName");
        String req = "scissors";      
        String html = "<h1>Incoming order from Room 220</h1><p>Request: "+req+"</p><p>Date: 5:30 PM Jan 24, 2021</p><a href='https://iconsportal.netlify.app/response?info={\"id\":[\""+itemID+"\"],\"date\":Date().toString(),room:\""+room+"\",mail:\""+sharedPref.getString("mail",null)+"\"' >Click to accept order on the iCons Portal</a>";
